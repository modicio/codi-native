...
/**
 * <p>Tuple to represent a [[codi.core.Fragment Fragment]] for serialisation.
 * <p>This class is produced by the Fragment itself.
 * <p>This class represents only [[codi.core.Node Nodes]] in
 * the reference case, but Nodes and concrete [[codi.core.BaseModel BaseModels]] in the instantiated case. This is because
