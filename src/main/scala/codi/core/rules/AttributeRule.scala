...
object AttributeRule {
   ...
   * @param datatype datatype of the attribute, see [[codi.core.rules.AttributeRule AttributeRule]]
   * @param nonEmpty see [[codi.core.rules.AttributeRule AttributeRule]]
