...
/**
 * <p>Overall abstract class to represent any rule held by a [[codi.core.Definition Definition]] or [[codi.core.BaseModel BaseModel]].
 * <p>Instances of this class and their concrete implementations are stored as [[codi.core.datamappings.RuleData]] by
 ...
 *
 * @see [[codi.core.Definition]]<p>[[codi.core.BaseModel]]<p>[[codi.core.datamappings.RuleData]]
...
object Rule {
   ...
   * <p> if AutoID is enabled, this method will retrieve a new unique random identifier form the [[codi.util.Identity Identity]]
   * object.
   *
